...
<html lang="en">
   <head>
      ...
      <spring:url value="/contact/" var="urlForm"></spring:url>
   ...
   <body>
     ...
     <jsp:include page="../includes/menu.jsp"></jsp:include>
      ...
      <div class="container theme-showcase" role="main">
         ...
         <form:form action="${urlForm}save" class="form-horizontal" method="post" modelAttribute="instanciaContactos">
            ...
            <div class="form-group">
               ...
               <div class="form-check">
                  ...
                  <label> <form:radiobuttons class="form-check-input" path="rating" items="${listaRating}"/> </label>
