	...
	<section class="ftco-section">
		<div class="container theme-showcase">
			<div class="panel panel-default">
				<div class="panel-heading" style="background-color: #82ae46;color: #f8f9fa;">
					<h3 class="panel-title" style="color: white; padding: 20px;">ACERCA DE ESTA APLICACION</h3>
				</div>
				<div class="panel-body">
					<div class="row">
						...
						<div class="col-sm-9">
							<div class="panel panel-default">
								<div class="panel-heading" style="background-color: #82ae46;color: #f8f9fa;">
									<h4 class="panel-title" style="color: white; padding: 20px;">Spring MVC, Spring Security y Spring Data JPA - Desarrollo Web con Spring 5</h3>
								</div>
								<div class="panel-body">
									...
									<div class="alert alert-danger" role="alert">ESTA APLICACION DEMO ES PARA QUE PUEDAS VER LA FUNCIONALIDAD COMPLETA DE LA APLICACION
										CON FINES DIDACTICOS, POR LO TANTO PUEDES CREAR, ACTUALIZAR Y HASTA ELIMINAR REGISTROS.
									</div>									
								</div>
							</div>
						</div>
