...
<html lang="en">
  ...
  <body>
    ...
    <div class="container theme-showcase" role="main">
      ...
      <a href="${urlRoot}" class="btn btn-success" role="button" title="Nueva Pelicula" >Nueva</a><br><br>
            ...
            <c:forEach var="noticia" items="${noticias.content}">
	            <tr>
	                ...
	                <td>
	                    ...
	                    <a href="${urlDelete}${noticia.id}" onclick='return confirm("¿Desea Eliminar?")' class="btn btn-danger btn-sm" role="button" title="Eliminar" ><span class="glyphicon glyphicon-trash"></span></a>
	                </td>
	            </tr>
            </c:forEach> 
        </table>
